...
// Wed Nov 30 11:21:44 2022 by ROOT version 6.20/04
// from TTree T/Geant4 SBS Simulation
// found on file: genrp_1_beam.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("genrp_1_beam.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("genrp_1_beam.root");
      }
      f->GetObject("T",tree);
